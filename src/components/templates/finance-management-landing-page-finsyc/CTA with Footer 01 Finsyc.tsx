  ...
  return (
    <motion.button
      ...
      className={cn(
        ...
        isPrimary
          ? "bg-[#052718] text-white shadow-[0_8px_32px_rgba(4,39,24,0.15)]"
          : "bg-white/20 backdrop-blur-xl border border-white/60 text-[#052718] w-full sm:w-[232px] justify-between shadow-[0_8px_32px_rgba(255,255,255,0.1)]",
    ...
    >
      ...
      <motion.div
        ...
        className={cn(
          ...
          isPrimary ? "bg-white" : "bg-[#052718]"
        )}
      >
        <ArrowUpRight className={cn("w-4 h-4", isPrimary ? "text-[#052718]" : "text-white")} />
      </motion.div>
    </motion.button>
  );
}
          ...
          <div className="max-w-[1440px] w-full mx-auto px-6 lg:px-[96px] relative z-10 flex flex-col items-center">
            <div className="max-w-[1248px] w-full flex flex-col items-center">
              ...
              <motion.h2
                ...
                viewport={{ once: true }}
                className="w-full max-w-[742px] text-center text-[#052718] font-semibold text-[42px] md:text-[68px] leading-[1.1] md:leading-[80px] tracking-tight md:tracking-[-2.2px] mb-[12px]"
              ...
              <motion.p
                ...
                viewport={{ once: true }}
                className="w-full max-w-[660px] text-center text-[#052718] font-sans text-lg md:text-[20px] leading-[1.5] md:leading-[30px] tracking-tight md:tracking-[-0.4px] opacity-80 mb-[64px]"
              >
          ...
          <div className="relative z-10 w-full max-w-[1440px] px-6 lg:px-[96px] pt-[64px] pb-[32px] flex flex-col items-start bg-transparent">
            ...
            >
              ...
              <div className="w-full lg:w-[440px] flex flex-col gap-6">
                <motion.h3
                  ...
                  className="text-[#052718] text-[24px] font-semibold leading-[30px] tracking-[-0.8px]"
                  style={{ fontFamily: "'Onest', sans-serif" }}
                >
                ...
                <motion.p
                  variants={itemVariants}
                  className="text-[#052718] font-sans text-[18px] font-normal leading-[28px] opacity-80"
                >
                ...
                >
                  <input
                    ...
                    className="flex-1 bg-transparent border-none outline-none px-4 py-2 sm:py-0 font-sans text-[18px] text-[#052718] placeholder:text-[#052718]/60"
                  />
                  <button className="flex items-center justify-between sm:justify-start gap-3 bg-white pl-6 pr-2 py-2 sm:pl-[24px] sm:pr-[8px] sm:py-[8px] rounded-full shadow-sm hover:shadow-md transition-all duration-300 group">
                    <span className="font-sans text-[18px] font-medium text-[#052718]">Subscribe</span>
                    <div className="w-[36px] h-[36px] bg-[#052718] rounded-full flex items-center justify-center transition-colors duration-300 shrink-0">
                  ...
                  <ul className="flex flex-col gap-[16px]">
                    {["Features", "Integrations", "Pricing", "Security"].map((link: string) => (
                      <motion.li key={link} variants={itemVariants}>
                        <a href="#" className="text-[#052718] font-sans text-[18px] font-normal leading-[28px] opacity-80 hover:opacity-100 hover:font-medium transition-all">{link}</a>
                      </motion.li>
                    ))}
                  </ul>
                  <div className="absolute top-0 -right-[32px] h-full w-[1px] bg-[#052718]/10 hidden lg:block" />
                </div>
                  ...
                  <ul className="flex flex-col gap-[16px]">
                    {[
                      ...
                      <motion.li key={social.name} variants={itemVariants}>
                        <span className="flex items-center gap-3 text-[#052718] font-sans text-[18px] font-normal leading-[28px] opacity-80 hover:opacity-100 hover:font-medium transition-all">
            ...
            <div className="w-[342px] h-[120px] md:w-[720px] md:h-[250px] lg:w-[1248px] lg:h-[430px] flex flex-col justify-center items-center select-none mx-auto lg:mx-0">
              <motion.h1
                ...
                className="w-full text-center text-[#052718] text-[116px] md:text-[244px] lg:text-[424px] font-bold leading-none tracking-[-3.8px] md:tracking-[-8px] lg:tracking-[-14px]"
                style={{ fontFamily: "'Onest', sans-serif" }}
              >
                Finsyc
              </motion.h1>
            ...
            >
              <div className="flex items-center gap-8 text-white font-sans text-[18px] font-normal leading-[28px] opacity-80">
                <span className="hover:opacity-100 hover:font-medium transition-all">Terms & Conditions</span>
                <span className="hover:opacity-100 hover:font-medium transition-all">Privacy Policy</span>
              </div>
