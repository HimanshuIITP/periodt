...
function Counter({ value, suffix }: CounterProps) {
  ...
  return (
    <div ref={ref} className="flex justify-center items-baseline gap-[2px]">
      <motion.span className="text-[#052718] text-[52px] font-semibold leading-[58px] tracking-[-1.8px]">
        {display}
      </motion.span>
  ...
  return (
    ...
    >
      <div className="flex flex-col items-start w-full sm:w-[294px] p-[20px_24px] gap-2.5 rounded-[24px] bg-white/40 backdrop-blur-md border border-white/20 shadow-[0_8px_32px_rgba(4,39,24,0.06)]">
        ...
        <p className="text-[#052718] text-[18px] font-medium leading-[28px]">
          {title}
        </p>
      </div>
      <p className="mt-4 text-[#052718] text-[16px] font-normal leading-[24px] tracking-[-0.3px] opacity-80 line-clamp-2 pr-[20px]">
        {description}
      </p>
    </motion.div>
  );
        ...
        <section className="w-full bg-[#F7FDFE] py-16 lg:pt-32 lg:pb-16 overflow-hidden flex justify-center">
          <div className="w-full max-w-[1248px] px-6 lg:px-0 flex flex-col items-center">
            <motion.div
              ...
              whileInView={{ y: 0, opacity: 1 }}
              viewport={{ once: true }}
              className="flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#E4F3ED] border border-[#052718]/[0.08]"
            >
              <Sparkles size={14} strokeWidth={3} className="text-[#15803C]" />
              <span className="text-sm font-medium text-[#15803C]">Key Metrics</span>
            </motion.div>
        ...
        <section className="w-full bg-[#F7FDFE] py-16 lg:pt-16 lg:pb-32 overflow-hidden flex justify-center">
          <div className="w-full max-w-[1440px] flex flex-col items-center overflow-hidden">
            ...
            <div className="w-full max-w-[1248px] px-6 lg:px-0 flex flex-col items-center text-center mt-0 mb-16">
              <div className="inline-flex items-center gap-2 px-3 py-0.5 rounded-full bg-[#128F5F]/[0.05] border border-[#128F5F]/10 mb-4">
                <Star className="w-3.5 h-3.5 text-[#128F5F] fill-[#128F5F]" />
                <span className="text-[14px] font-medium text-[#128F5F] tracking-tight">Testimonials</span>
              </div>

              <h2 className="text-[#052718] text-[28px] sm:text-[36px] md:text-[52px] font-semibold leading-tight tracking-tight max-w-[690px] mb-4 lg:mb-6">
                Trusted by people <i className="text-[rgba(0,0,0,0.40)]">who take</i> control of their finances
              </h2>

              <p className="text-[#052718] opacity-80 text-[16px] md:text-[18px] leading-[24px] md:leading-[28px] max-w-[576px]">
                          ...
                          <div className="flex items-center justify-center min-h-[90px] md:min-h-[102px] mb-[48px]">
                            <p
                              className={
                                ...
                                (isActive ? "text-white " : "text-[#052718] ") +
                                (isActive
                          ...
                          <div className="flex flex-col items-center">
                            ...
                            <p
                              className={
                                ...
                                (isActive ? "text-white/80" : "text-[#052718] opacity-80")
                              }
                            >
                              {item.role}
                            </p>
            ...
            <div className="w-full max-w-[1248px] flex items-center justify-center gap-3 mt-12">
              ...
              >
                <ArrowLeft className="w-5 h-5 md:w-6 md:h-6 text-[#052718]" />
              </button>
              <button
                onClick={() => handleNext()}
                className="w-[48px] h-[48px] md:w-[60px] md:h-[60px] rounded-full transition-all duration-300 flex items-center justify-center cursor-pointer bg-[#052718] hover:bg-[#052718]/90 shadow-lg"
              >
