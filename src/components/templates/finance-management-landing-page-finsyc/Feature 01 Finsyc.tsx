...
function FeatureCard({ title, description, icon: Icon, uiSrc, width: _width, className = "", delay = 0, isMounted = false }: FeatureCardProps) {
  return (
    <motion.div
      ...
      className={"flex flex-col items-start shrink-0 border border-[#052718]/10 overflow-hidden bg-white group w-full rounded-[24px] sm:rounded-[32px] " + (className || "")}
    >
      ...
      <div className="p-6 sm:p-10 flex flex-col sm:flex-row items-start gap-5 self-stretch bg-white">
        ...
        <div className="flex flex-col gap-[10px]">
          <h3 className="text-[#052718] font-onest text-xl sm:text-2xl font-semibold leading-tight sm:leading-[30px] tracking-[-0.8px]">
            {title}
          </h3>
          <p className="text-[#052718] font-inter text-base sm:text-lg font-normal leading-relaxed sm:leading-[28px] opacity-80">
            {description}
          </p>
        </div>
      </div>
...
export default function OriginaFinsycFeature({ className }: { className?: string }) {
  ...
  return (
    <>
      ...
      <section className={"w-full bg-[#FFFEFE] py-20 lg:py-32 overflow-hidden " + (className || "")}>
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-col items-center">
              ...
              <motion.h2
                ...
                className="mt-6 w-full max-w-[686px] text-[#052718] text-center font-onest text-[32px] sm:text-[40px] lg:text-[52px] font-semibold leading-tight lg:leading-[58px] tracking-[-1.2px] sm:tracking-[-1.8px]"
              >
                Master Your Money
              ...
              <motion.p
                ...
                className="mt-3 w-full max-w-[514px] text-[#052718] text-center font-inter text-base sm:text-lg font-normal leading-relaxed sm:leading-7 opacity-80"
              >
