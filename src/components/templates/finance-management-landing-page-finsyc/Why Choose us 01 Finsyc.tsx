...
function BenefitItem({ title, description, icon: Icon, delay = 0 }: BenefitItemProps) {
  return (
    ...
    >
      <div className="flex-shrink-0 w-10 h-10 bg-[#f9fbfa] border border-[#F9F9FC] rounded-lg flex items-center justify-center">
        <Icon className="w-5 h-5 text-[#128F5F]" strokeWidth={2.5} />
      </div>
      <div className="flex flex-col gap-1">
        <h3 className="text-[#052618] font-onest text-[20px] md:text-[24px] font-semibold leading-[26px] md:leading-[30px] tracking-[-0.6px] md:tracking-[-0.8px]">
          {title}
        </h3>
        <p className="text-[#052618] font-sans text-base md:text-[18px] font-normal leading-[24px] md:leading-[28px] opacity-80">
          {description}
        </p>
      </div>
    </motion.div>
            ...
            <div className="flex flex-col lg:flex-row items-start gap-16 lg:gap-[48px] justify-between">
              ...
              <div className="w-full lg:max-w-[622px] flex flex-col items-start lg:sticky lg:top-[120px] self-start">
                ...
                <motion.h2
                  ...
                  className="text-[#052618] font-onest text-[32px] sm:text-[42px] md:text-[52px] font-semibold leading-[38px] sm:leading-[48px] md:leading-[58px] tracking-[-1.2px] md:tracking-[-1.8px] mb-3"
                >
                ...
                <motion.p
                  ...
                  className="text-[#052618] font-sans text-lg md:text-[20px] font-normal leading-[24px] md:leading-[30px] opacity-80 mb-16 max-w-[560px]"
                >
                ...
                <div className="flex flex-wrap gap-3">
                  {tags.map((tag: string, idx: number) => (
                    <motion.span
                      ...
                      className="px-6 py-3 border border-[#052618]/10 rounded-full text-[#052618] font-sans text-[16px] md:text-[18px] font-normal hover:bg-[#F6FDFF] transition-colors cursor-default"
                    >
                      {tag}
                    </motion.span>
                  ))}
