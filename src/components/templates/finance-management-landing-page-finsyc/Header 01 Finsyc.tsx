          ...
          >
              ...
              {navItems.map((item: string) => (
                <li key={item}>
                  <a
                    href="#"
                    className={
                      "font-inter text-base leading-6 tracking-[-0.3px] text-[#052718] transition-all " +
                      (item === "Home"
            ...
            <div className="flex items-center gap-4">
              ...
              >
                <motion.span
                  layout
                  className="font-inter text-base font-medium leading-6 tracking-[-0.3px] text-[#052718]"
                >
                  Get Started
                </motion.span>
                ...
                >
                  ...
                  >
                    <ArrowUpRight className="w-3 h-3 text-[#052718]" />
                  </motion.div>
                </motion.div>
              </motion.button>
              ...
              <button
                ...
                className="lg:hidden p-2 text-[#052718] bg-white/20 backdrop-blur-md rounded-full"
              >
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="p-2 text-[#052718] bg-[#052718]/5 rounded-full"
                  >
                    <X size={24} />
                  </button>
                </div>
                  ...
                  {navItems.map((item: string, idx: number) => (
                    ...
                    >
                      <a
                        href="#"
                        onClick={() => setIsMobileMenuOpen(false)}
                        className="font-inter text-2xl font-semibold text-[#052718]"
                      >
                        {item}
                      </a>
                    </motion.li>
                ...
                <div className="mt-auto">
                  <button className="w-full py-4 rounded-full bg-[#052718] text-white font-inter font-medium text-lg">
                    Get Started
                  </button>
                </div>
              </motion.div>
          ...
          <div className="flex flex-col items-center mt-12 lg:mt-[80px]">
            ...
            >
              <div className="flex items-center gap-1 shrink-0">
                <Sparkles className="w-3.5 h-3.5 sm:w-4 sm:h-4 fill-[#052718] text-[#052718]" />
                <span className="font-inter text-sm sm:text-base lg:text-[18px] font-medium leading-[28px] text-[#052718]">
                  4.9 rating
                </span>
              </div>
            ...
            <motion.h1
              ...
              className="max-w-[750px] w-full text-center font-onest text-[40px] sm:text-[50px] lg:text-[66px] font-semibold leading-tight lg:leading-[72px] tracking-tight lg:tracking-[-3px] text-[#052718]"
            >
            ...
            <motion.p
              ...
              className="max-w-[630px] w-full text-center mt-5 font-inter text-lg lg:text-[20px] font-normal leading-relaxed lg:leading-[30px] tracking-[-0.4px] text-[#052718]"
            >
            ...
            <motion.button
              ...
              layout
              className={
                "flex items-center gap-3 py-2 rounded-full bg-[#052718] mt-8 lg:mt-12 group cursor-pointer relative h-14 border border-white/20 transition-all duration-300 " +
            ...
            >
              ...
              >
                ...
                >
                  <ArrowUpRight className="w-4 h-4 text-[#052718]" />
                </motion.div>
              </motion.div>
            </motion.button>
